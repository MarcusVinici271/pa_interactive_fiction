...
@export var salas_resumidas: Dictionary = {
	"inicio": {
		...
		"Descricao": "A pequena enfermaria contém três camas simples. Na prateleira, estão os frascos de remédios e as ataduras, enquanto um pilão e ervas indicam a preparação de medicamentos.",
	...
	"santuario_tisadya": {
		...
		"Descricao": "Você está de volta ao santuário. O chão de lajotas gastas leva aos bancos e ao altar de pedra onde se ergue a estátua de Tisadya. Pequenas oferendas dos fiéis ainda estão dispostas aos pés da imagem.",
	...
	"aposentos_eleyren": {
		...
		"Descricao": "O aposento de Éleyren, com o cheiro suave de ervas e incenso misturado ao pergaminho. A luz aqui é fraca, vinda de uma única vela e de uma estreita fresta na parede. O quarto contém uma cama e um baú de madeira. No nicho da parede, repousa uma estátua em miniatura de Tisadya.",
		"DescricaoSaidas": "Ao [b]oeste[/b] uma porta de mandeira leva de volta ao Santuário.",
		"Saidas": { "oeste": "santuario_tisadya" }
	},
	"cemiterio": {
		"Nome": "Cemitério",
		"Descricao": "O ar frio envolve o cemitério murado, onde o vento e os corvos quebram o silêncio. As lápides de pedra e cobertas de líquen pontilham a grama alta. Ao fundo, o mausoléu com sua porta de ferro enferrujada domina o muro norte.",
	...
	"lugar_escuro": {
		"Nome": "Lugar Escuro",
		"Descricao": "Você está de volta ao beco escuro e sem saída. O espaço é apertado entre o muro do cemitério e a parede do armazém, cheio de barris e sacos quebrados. A lamparina enferrujada mal ilumina a figura de Toyol, que continua afiando sua adaga, encostado na parede.",
	...
	"mausoleu_bezeit": {
		...
		"Descricao": "Você retorna ao pequeno cômodo octogonal do mausoléu. O ar é pesado e frio, com cheiro de mofo. No centro, repousa o grande sarcófago. Na parede oposta à entrada, o brasão da família Bezeit está coberto de teias.",
	...
	"jardim_santuario": {
		...
		"Descricao": "Você está no pequeno pátio murado que serve de entrada para o santuário. O espaço é dominado pelos canteiros cheios de ervas e plantas medicinais crescendo de forma organizada. Contra o muro oeste, um banco te convida ao descanso.",
	...
	"praca_central": {
		"Nome": "Praça Central",
		"Descricao": "Você está no coração da vila Boeka, um espaço aberto de terra batida onde o ar vibra com o som das vozes e atividades. O elemento central é o poço de pedra, cuja borda está gasta pelo uso constante das cordas.",
	...
	"estoque_taverna": {
		...
		"Descricao": "Você está de volta ao estoque. O chão de pedra grudento e as estantes vazias dão um ar de abandono. Caixas soltas e cobertas por teias de aranha estão empilhadas no centro, e um canto de dormir improvisado está parcialmente escondido nos fundos.",
	...
	"estalagem": {
		...
		"Descricao": "O barulho da taverna ainda é audível aqui. O quarto é pequeno e quase todo ocupado pela cama, com seu colchão irregular. Uma cômoda ao lado sustenta a bacia e a jarra de água. A única janela deixa entrar uma luz cinzenta.",
	...
	"rua_principal_13": {
		"Nome": "Rua Principal",
		"Descricao": "Você está na principal rua de comércio. O ambiente é dominado pelo barulho e calor da forja de frente aberta ao norte. Diretamente ao sul, a loja de armaduras, identificada pela placa do elmo e peitoral, chama a atenção. A Praça Central está a oeste.",
	...
	"forja_thovak": {
		...
		"Descricao": "Você está na forja . A bigorna maciça domina o centro, e a fornalha incandescente irradia calor intenso. As paredes estão cheias de ferramentas e peças de metal. Thorvak, o ferreiro anão, está ao lado da bigorna, limpando o suor.",
	...
	"aposento_thovak": {
		...
		"Descricao": "Você entra no aposento de Thorvak, escuro de fuligem. A cama baixa e larga, coberta por peles, ocupa o espaço. Um caixote virado serve de mesa. O aposento contém um baú pesado reforçado com ferro e um suporte vazio na parede, feito para um grande machado.",
	...
	"loja_armadura": {
		...
		"Descricao": "As batidas em ritmo da forja são ouvidas e o cheiro forte de couro e óleo domina o ar. O lugar está abarrotado com peças de armadura penduradas em vigas e espalhadas por prateleiras e mesas. Gor-Noj, está atrás do balcão, polindo um escudo de metal, e levanta os olhos para você.",
		"DescricaoSaidas": "A porta ao [b]norte[/b] leva de volta à Rua Principal.",
		"Saidas": { "norte": "rua_principal_13" }
	},
	"portao_leste_19": {
		"Nome": "Portão Leste",
		"Descricao": "Você está no final da rua principal, onde a alta paliçada de madeira cerca a vila. O Portão Leste, está entreaberto. O guarda humano Beder está no lado norte e a guarda anã Nirja no lado sul. A plataforma de vigia está acima, e o caminho de terra se estende para o leste.",
	...
	"rua_principal_14": {
		"Nome": "Rua Principal",
		"Descricao": "Você está de volta à Rua Principal usada para logística. Ao norte, ergue-se o Posto da Milícia, um edifício robusto com a bandeira da vila. Ao sul, há apenas mato alto e as ruínas de um armazém, de onde parte um caminho estreito para o Portão Sul.",
	...
	"portao_sul": {
		"Nome": "Portão Sul",
		"Descricao": "O Portão Sul, uma estrutura imponente de madeira e ferro que parece estar permanentemente fechada. O cheiro de piche e mofo paira no ar. O arqueiro Elnor está na vigia, e a maga Kel está ao lado, observando o caminho além do portão.",
	...
	"posto_milicia": {
		...
		"Descricao": "O Posto da Milícia, com um mapa grande e marcado, está estendido sobre a mesa central. Estandes com armas , lanças e escudos estão nas paredes. O Capitão Jaffer observa o movimento de sua mesa no canto oeste.",
	...
	"aposento_jaffer": {
		...
		"Descricao": "Você entra no quarto de Jaffer. O lugar é funcional: uma cama de campanha, com seu cobertor dobrado com precisão militar, e um baú pessoal aos pés. Uma janela gradeada e um suporte de armas vazio chamam a atenção.",
	...
	"aposento_guarda": {
		...
		"Descricao": "O dormitório é quente e abafado, com forte cheiro de suor e couro velho. O espaço está abarrotado com seis beliches desarrumados e baús pessoais por baixo. No centro, uma mesa está coberta por canecas e migalhas, e roupas sujas estão jogadas no chão.",
	...
	"treinamento_milicia": {
		...
		"Descricao": "Você retorna ao pátio de armas, com o chão de terra batida e boa ventilação. O foco está nos três bonecos de treino de palha, visivelmente esfarrapados pelos golpes. Um rack de armas na parede contém espadas cegas e escudos de prática.",
		"DescricaoSaidas": "A arcada a [b]oeste[/b] leva de volta ao salão principal do Posto da Milícia.",
		"Saidas": { "oeste": "posto_milicia" }
	},
	"prisao_milicia": {
		"Nome": "Prisão",
		"Descricao": "O ar é frio, parado e fétido, com o teto baixo gotejando. A lamparina lança sombras distorcidas na prisão da vila. Duas celas robustas de ferro enferrujado ocupam a parede norte. O resto do espaço está cheio de barris velhos e caixas quebradas, e uma mesa marca o posto de guarda vazio.",
	...
	"rua_principal_15": {
		"Nome": "Rua Principal",
		"Descricao": "Você está na seção final da Rua Principal. Ao sul, a pequena loja do Recanto da Alquimista se destaca. A fumaça roxa pálida saindo da chaminé a identificam.",
	...
	"travessa_oeste_29": {
		"Nome": "Travessa Oeste",
		"Descricao": "Você volta para o caminho tranquilo de cascalho. A casa ao leste se destaca das outras: a madeira tratada e a pintura fresca da porta mostram cuidado, e pequenos vasos de ervas florescem na janela.",
	...
	"casa_golirin": {
		"Nome": "Casa Gólirin",
		"Descricao": "O chão de madeira reflete a luz da janela. O ambiente é composto por uma estante cheia de pergaminhos, uma cama com lençois e uma mesa ao centro. Aos pés da cama, um baú de madeira escura tem entalhes élficos.",
		"DescricaoSaidas": "Para voltar digite [b]oeste[/b].",
		"Saidas": { "oeste": "travessa_oeste_29" }
	},
	"travessa_oeste_30": {
		"Nome": "Travessa Oeste",
		"Descricao": "Você chega ao pátio de pedra varrido no final da Travessa Oeste. O ar é calmo em frente à estrutura residencial mais imponente da vila, que projeta uma longa sombra. O portão de ferro é flanqueado por dois guardas da milícia, que parecem tensos no posto.",
